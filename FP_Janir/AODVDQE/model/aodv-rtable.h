...
class RoutingTableEntry
{
  public:
    ...
    //tambahan
    // --- TAMBAHAN AODV-DQE: Setter & Getter Cost ---
    /**
     * Set the path cost (Dijkstra metric)
     * \param c the path cost
     */
  ...
  private:
    ...
    //tambahan
    // --- TAMBAHAN AODV-DQE ---
    double m_pathCost; // Menyimpan akumulasi biaya rute (QoS + Energi + Mobilitas)
    // -------------------------
};
