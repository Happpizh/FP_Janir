...
//tambahan
#include "ns3/vector.h" // TAMBAHAN UNTUK AODV-D
...
class RreqHeader : public Header
{
  public:
    ...
    //tambahan
    // --- TAMBAHAN AODV-D: Getter & Setter Posisi dan Kecepatan ---
    ...
    // --- TAMBAHAN AODV-DQE: Setter & Getter ---
  ...
  private:
    ...
    //tambahan
    // --- TAMBAHAN AODV-D: Variabel Penyimpan ---
    Vector m_position; // Menyimpan posisi X, Y, Z
    Vector m_velocity; // Menyimpan kecepatan vektor X, Y, Z

    // --- TAMBAHAN AODV-DQE: Variabel Penyimpan ---
    double m_energy;    // Sisa energi pengirim (0.0 - 1.0)
    double m_pathCost;  // Akumulasi biaya rute sejauh ini
    // ---------------------------------------------
    // -------------------------------------------
};
...
class RrepHeader : public Header
{
  ...
  private:
    ...
    // --- TAMBAHAN AODV-DQE ---
    double m_energy;    // Sisa energi pengirim
    double m_pathCost;  // Akumulasi biaya rute
    // -----------------------
};
